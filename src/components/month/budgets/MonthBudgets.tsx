                ...
                <SortableItem key={budget.id} id={budget.id || 0}>
                  ...
                  >
                    <div className="collapse">
                        ...
                        <div className="flex items-center gap-3 w-full sm:w-auto sm:flex-1 sm:min-w-0">
                          ...
                          >
                            <Wallet
                              className={cn(
                                "w-5 h-5",
                                !hasColor && "text-secondary"
                              )}
                              style={
                                hasColor ? { color: budget.color } : undefined
                              }
                            />
                          </div>
                        ...
                        <div className="flex items-center justify-between sm:justify-end gap-4 pl-13 sm:pl-0">
                          <div className="flex items-center gap-3 sm:gap-4">
                            <div className="text-left sm:text-right">
                              ...
                              >
                                {budgetRemaining >= 0
                                  ? `${euro(budgetRemaining)} left`
                                  : `${euro(Math.abs(budgetRemaining))} over`}
                              </p>
                            </div>
                      ...
                      {/* Expenses Content */}
                      <div className="collapse-content p-0 bg-base-200/30 rounded-lg mr-2 sm:mr-3 peer-checked:mb-3">
                        <div className="px-3 sm:px-3 pt-3 sm:pt-4">
                          {expenseCount === 0 ? (
                            <div className="text-center py-5 text-base-content/50">
